...
//////////////////////////////////////////////////////////////////////////
Is::Is(const is_func f) :func(f), count(-1)
{
}

Is::Is(const is_func f, int c):func(f), count(c)
{
}
...
//////////////////////////////////////////////////////////////////////////
Range::Range(char f, char t) : from(f), to(t), count(-1)
{
}

Range::Range(char f, char t, int c): from(f), to(t), count(c)
{
}
